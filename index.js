...
const MENU = [
  {
    title: "🇨🇳 Хятад",
    url: "https://esim.beez.mn/product/china/",
  },
  {
    title: "🇰🇷 Солонгос",
    url: "https://esim.beez.mn/product/korea/",
  },
  {
    title: "🇯🇵 Япон",
    url: "https://esim.beez.mn/product/%d1%8f%d0%bf%d0%be%d0%bd/",
  },
  {
    title: "🌏 Бусад орон",
    url: "https://esim.beez.mn/",
  },
];
...
async function sendGreeting(recipientId) {
  await axios.post(
    GRAPH_URL,
    {
      ...
      message: {
        text: "Сайн байна уу? 🌏 Та хаашаа аялах вэ?",
      },
    },
...
async function sendButtonMenu(recipientId) {
  await sendButtons(recipientId, "✈️ Очих улсаа сонгоно уу:", MENU);
}
